...
#If Win64 Then
		...
		ofDialog.Filter = "Catalog Index File (*.pdx) | *.pdx"
		...
		Else
			sBuffer = ""
		End If
#Else  'VB6.GetHInstance is suupported within 32 bit processes only. https://docs.microsoft.com/en-us/dotnet/api/microsoft.visualbasic.compatibility.vb6.support.gethinstance?view=netframework-4.8
