...
#if WIN_PLATFORM
	#define _E_RESTORE __noop // prevents Compiler Warning C4390
#else
	#define _E_RESTORE 
#endif
	...
	#define _E_RESTORE      ASPopExceptionFrame()
		...
		*/
		...
		struct _BadReturnCatcherStruct {
			...
			int E_RETURNOutsideDURINGBlockCheckSize; /* To make size of _BadReturnCatcherStruct is not same to size of int  */
		};
		...
		*/
		#define return for( sizeof(gBadReturnCatcher) != sizeof(int) ? gBadReturnCatcher = 1 : 0;; ) return
