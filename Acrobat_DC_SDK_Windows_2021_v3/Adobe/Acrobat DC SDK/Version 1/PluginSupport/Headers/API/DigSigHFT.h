...
#define PROP_DSSigProp_DigestEncryptionAlgo	"digestEncryptionMethod"
...
#define PROP_DSSigProp_TrustSource			"TrustSource"

/* This prop indicates the EU qualified status of the sign.
Requirements for Eu qualified: a) cert should be EU qualified
b) the cert is created by SSCD or QSCD. Read the ETSI EN 319-412-5 for more info.
This is currently used in sig panel and the sig prop dialog.
*/
#define PROP_DSSigProp_QualifiedSign		"QualifiedSign"

#define PROP_DSSigProp_RevocationGoOnline	"RevocationGoOnline"

//This prop keeps track whether the signature is validated atleast once
#define PROP_DSSigProp_SigValidated			"SigValidated"
/**
