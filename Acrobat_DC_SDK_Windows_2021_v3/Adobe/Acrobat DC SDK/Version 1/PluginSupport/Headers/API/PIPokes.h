...
/**
	The AcroAppComponent has been destroyed.
	@param comp, The component that has been destroyed.
	@param clientData A pointer to a block of user-supplied
	data that was passed when the client registered for this
	notification using <code>AVAppRegisterNotification()</code>.
*/
POKE(AcroAppComponentDestroyed, (void *comp ) , (void * comp, void *clientData), (comp, cell->clientData))

/**
	The App mode has switched to Pro for SingleAppClient.
	@param clientData A pointer to a block of user-supplied
	data that was passed when the client registered for this
	notification using <code>AVAppRegisterNotification()</code>.
*/
POKE(AcroAppModeSwitch, (void), (void* clientData), (cell->clientData))