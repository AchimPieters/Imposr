...
#define PDPageDrawContentsToWindowEx2 (ACROASSERT(gPDModelVersion >=PDModelHFT_VERSION_10), *((PDPageDrawContentsToWindowEx2SELPROTO)(gPDModelHFT[PDPageDrawContentsToWindowEx2SEL])))
#endif /* #if !MAC_PLATFORM || (MAC_PLATFORM && !AS_ARCH_64BIT) */
...
#define PDFileAttachmentGetFileSize64 (ACROASSERT(gPDModelVersion >=PDModelHFT_VERSION_13), *((PDFileAttachmentGetFileSize64SELPROTO)(gPDModelHFT[PDFileAttachmentGetFileSize64SEL])))
