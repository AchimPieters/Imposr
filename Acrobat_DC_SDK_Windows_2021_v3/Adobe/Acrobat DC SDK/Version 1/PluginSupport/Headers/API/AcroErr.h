...
enum
{
	...
	*/
	...
	/**
		The dimension of this page is greater than the max units in user space coordinates.
		What this actually translates to is: MediaBox/CropBox etc in the Page object have values > 14400 user units(defined via MAX_MEDIA_BOX_SIDE_points, see PDPage.cpp)
		@ingroup PDPageErrors
	*/
	pdPErrPageDimOutOfRangeErrorMsg_Rendering
};
