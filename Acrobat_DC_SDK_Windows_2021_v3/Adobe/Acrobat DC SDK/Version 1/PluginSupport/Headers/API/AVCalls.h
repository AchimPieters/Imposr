...
#define AVAppRegisterLateInitProcWithName AVROUTINE(AcroViewHFT_VERSION_11_6, AVAppRegisterLateInitProcWithName)
...
#define AVStorageRegisterNewStorage AVROUTINE(AcroViewHFT_VERSION_12_3, AVStorageRegisterNewStorage)

#define AVStorageRegisterAccount AVROUTINE(AcroViewHFT_VERSION_12_3, AVStorageRegisterAccount)

#define AVStorageGetAccountInfo AVROUTINE(AcroViewHFT_VERSION_12_3, AVStorageGetAccountInfo)

#define AVStoragePerformOAuth2Authentication AVROUTINE(AcroViewHFT_VERSION_12_3, AVStoragePerformOAuth2Authentication)

#define AVMakeWebServicesRequest AVROUTINE(AcroViewHFT_VERSION_12_3, AVMakeWebServicesRequest)

/* AVPageViewDrawNowOptimized */
#define AVPageViewDrawNowOptimized AVROUTINE(AcroViewHFT_VERSION_12_3, AVPageViewDrawNowOptimized)

#ifdef MAC_PLATFORM
/* AVMakeAcrobatDefault */
#define AVMakeAcrobatDefault AVROUTINE(AcroViewHFT_VERSION_12_3, AVMakeAcrobatDefault)
#endif

/* AVWindowGetPlatformThingEx*/
#define AVWindowGetPlatformThingEx AVROUTINE(AcroViewHFT_VERSION_12_3, AVWindowGetPlatformThingEx)
