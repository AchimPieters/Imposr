...
/**
	...
	to pass to <code>cancelProc</code> each time it is called. It should be 
	<code>NULL</code> if <code>cancelProc</code> is <code>NULL</code>.
	@exception pdPErrUnableToCreateRasterPort is raised if Creation of a raster port gets failed.
	@see AVAppGetCancelProc 
...
/**
	...
	This API will return doing nothing on Mac 32.
	...
	@param window A pointer to a platform-dependent window object 
	(<code>HWND</code> on Windows, <code>WindowPtr</code>. On Windows, 
	to draw into an offscreen <code>DC</code>, pass <code>NULL</code> for <code>window</code>.
	@param displayContext A pointer to a platform-dependent 
	display context structure (<code>hDC</code> on Windows. 
...
/**
	...
	This API will return false on Mac 32.
...
/** Returns the size, in bytes, that the file will occupy if exported to disk.
	...
	determined.
*/
NPROC(ASUns64, PDFileAttachmentGetFileSize64, (PDFileAttachment attachment))
