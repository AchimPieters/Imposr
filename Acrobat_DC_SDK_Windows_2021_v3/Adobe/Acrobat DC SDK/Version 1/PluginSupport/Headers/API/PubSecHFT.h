...
//List of third party subfilter prefixes registered with Adobe
typedef enum {
	/*A subfilter is defined but it is not in list of prefixes registered with Adobe*/
	kSubFilterPrefixUnknown = 0,
	/** None */
	kSubFilterPrefixNone,
	/*PBAD prefix */
	kSubFilterPrefixPBAD,
	/* */
	kSubFilterPrefixEnumSize
