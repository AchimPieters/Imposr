...
#if PI_UITCORE_VERSION != 0
HFT gUITCoreHFT = 0;
ASUns32 gUITCoreHFTVersion = 0;
#endif
...
extern "C"
#endif
ASBool CALLBACK PlugInMainInner(ASUns32 appHandshakeVersion,
													ASUns32 *handshakeVersion,
													PISetupSDKProcType* setupProc,
													void* windowsData)
#else
extern "C" ASBool _far _pascal _export _loadds PlugInMainInner(ASUns32 appHandshakeVersion,
													ASUns32 *handshakeVersion,
													PISetupSDKProcType* setupProc,
													void* windowsData)
#endif /* else _WIN32 */
...
ASBool CALLBACK PlugInMain(ASUns32 appHandshakeVersion,
	...
	void* windowsData)
{
	return PlugInMainInner(appHandshakeVersion, handshakeVersion, setupProc, windowsData);
...
#if PI_UITCORE_VERSION != 0
		{"UITCORE",PI_UITCORE_VERSION,&gUITCoreHFTVersion,&gUITCoreHFT,
#ifdef PI_UITCORE_OPTIONAL
		 true},
#else
#if HAS_UI
		 false},
