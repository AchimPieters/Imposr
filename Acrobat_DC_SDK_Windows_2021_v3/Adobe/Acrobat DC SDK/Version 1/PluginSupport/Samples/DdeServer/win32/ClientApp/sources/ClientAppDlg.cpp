...
HDDEDATA CALLBACK CClientAppDlg::DdeCallback(UINT type, UINT format, HCONV hconv, HSZ hString1, HSZ hString2, HDDEDATA hData, ULONG_PTR dwData1, ULONG_PTR dwData2)
{
	return 0;
}
